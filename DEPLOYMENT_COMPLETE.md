...
- 또는: https://github.com/qquartsco-svg/Brain_Disorder_Simulation_Engine/releases

### 3. 새 릴리스 생성
- "Draft a new release" 또는 "Create a new release" 클릭

### 4. 릴리스 정보 입력

**Tag version**: `v1.0.0` (드롭다운에서 선택)

**Release title**: 
```
v1.0.0 - Research-Ready Release
```

**Description**:
`RELEASE_NOTES_v1.0.0.md` 파일의 전체 내용을 복사하여 붙여넣기
...
### Description 설정
1. 저장소 메인 페이지 → "⚙️ Settings" (또는 우측 "About" 섹션)
2. Description 입력:
```
...
### Topics 추가
저장소 메인 페이지 → "⚙️ Settings" → "Topics" 섹션에서 다음 태그 추가:
```
brain-simulation
...
축하합니다! Brain Disorder Simulation Engine v1.0.0이 성공적으로 GitHub에 배포되었습니다.

이제 전 세계 연구자들이 이 프로젝트를 사용할 수 있습니다!
